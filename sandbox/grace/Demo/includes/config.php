...
$config['fb']['redirectLogin'] = "http://localhost/epilogue/sandbox/grace/Demo/src/profile.php"; //"http://duidesign.com/j/login.php";
$config['fb']['redirectLogout'] = "http://localhost/epilogue/sandbox/grace/Demo/src/index.php"; //"http://duidesign.com/j/login.php";
